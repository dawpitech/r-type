       ...
       public:
        explicit Parser(int argc, char **argv) : _desc("Options"), _argc(argc), _argv(argv)
        {
            this->_desc.add_options()("help,h", "Display help message")("debug,d", "Enable debug mode")(
                "userpass,u", po::value<std::string>(), "Password to identify with network")(
                "port,p", po::value<uint16_t>(), "Set port to connect to")(
                "ip,i", po::value<std::string>(), "Ip of the server");
        };
