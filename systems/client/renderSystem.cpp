...
void RenderSystem(flux::ECS& ecs, flux::Entity entity)
{
    ...
    SDL_FRect pos{(float)sprite.srcRect.x, (float)sprite.srcRect.y, (float)sprite.srcRect.w, (float)sprite.srcRect.h};

    SDL_RenderTexture(sprite.sdlRenderer, sprite.texture, &pos, &sprite.destRect);
}
